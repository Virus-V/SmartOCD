...
-- JTAG 原生方式读取IDCODE
-- jtag:JtagToState(adapter.TAP_RESET)	-- TAP到RESET状态，默认连接IDCODE扫描链
jtag:JtagToState(adapter.TAP_DR_SHIFT)	-- TAP到DR-Shift状态，读取idcode
local raw_idcodes = jtag:JtagExchangeData(string.pack("I4I4I4I4", 0, 0, 0, 0), 128)
